    ...
    return (
        ...
        <div className="home_row">
           <Product id="4837237"
            ...
            />
           <Product id="11235675 "
            title="Stainless Steel Mixing Bowls with Lids - Nesting Bowls with Graters, Handle, Pour Spout, Airtight Lids - Non-Slip Mixing Bowl Set for Cooking, Baking, Prepping, Food Storage (Set Of 3) "
            price={34.99}
            rating={4}
           ...
           <Product 
           id="5842729"
           title="Simple Ecology Cloth Reusable Washable Face Mask : Set 4 Large Masks BLACK, GREEN, LAVENDER, and PINK "
           price={13.95}
           rating={4}
